                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<?php if(User::is_admin()){  ?>
							<div class="col-sm-8">
								<a href="<?=base_url()?>time_sheets/send_timesheet/<?=User::get_id();?>" data-toggle="ajaxModal" title="Email" class='btn btn-success'>  Email Time Sheet	</a>
							</div>
						<?php } ?>

						<div class='col-sm-1'>
							<a class="btn btn-success" href="<?=base_url()?>time_sheets/pdf"><?=lang('pdf')?></a>
						</div>
