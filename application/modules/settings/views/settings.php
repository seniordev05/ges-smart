<div class="content">
				...
				<div class="col-sm-4 col-md-4 col-lg-3 col-xs-12">
                    ...
                    //     $menus = $this->db->where('hook','settings_menu_custom')->where('visible',1)->order_by('order','ASC')->get('hooks')->result();
                    // }
					$menus = $this->db->where('hook','settings_menu_admin')->where('visible',1)->order_by('order','ASC')->get('hooks')->result();
					...
					foreach ($menus as $menu) { 
                        ...
                        if($menu->name != 'email_settings' && $menu->name != 'email_templates' && $menu->name != 'system_settings' && $menu->name != 'menu_settings') {
                        ?>
