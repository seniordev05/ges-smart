                ...
                <table class="table table-striped custom-table datatable" id="table-budget-expense">
                  ...
                  <tbody>
                    <?php $i = 1; foreach($budget_expenses as $budget){ 
                      ...
                      if (strlen($budget['po_code']) == 1) {
                        $pocode = '000' .$budget['po_code'];
                      } else if (strlen($budget['po_code']) == 2) {
                        $pocode = '00' .$budget['po_code'];
                      } else if (strlen($budget['po_code']) == 3) {
                        $pocode = '0' .$budget['po_code'];
                      } else {
                        $pocode = $budget['po_code'];
                      }
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">PO<?php echo $pocode; ?></td>
                       ...
                       <!--  <td><?php echo ucfirst($budget['budget_type']); ?></td>
                        ...
                        <td>
                         <?=Applib::format_currency($inv->currency, $budget['amount'])?>
                        </td>
                    ...
                    if(count($dgt_payments)>0){
                      ...
                      <tr>
                        ...
                        <!-- <td><?php echo substr($dgt_payment['notes'],0,5).'...';?></td> -->
                        ...
                        <td style="text-align: center;"><?php echo substr($dgt_payment['notes'],0,16).'...';?></td>
                         <td class="text-right">
                          <div class="dropdown">
                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                            <ul class="dropdown-menu pull-right">
                              <li><a href="<?php echo base_url(); ?>invoices/edit/<?php echo $dgt_payment['inv_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                             <!--  <li><a href="#" data-toggle="modal" data-target="#delete_budget<?php echo $budget['id']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a></li> -->
                            </ul>
                          </div>
                        </td> 
