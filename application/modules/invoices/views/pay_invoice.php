...
<section class="content">
        ...
        <input type="text" class="form-control" value="<?=Applib::format_deci(Invoice::get_invoice_due_amount($id));?>" name="amount">
                    ...
                    <input type="hidden" class="form-control"  value="<?=Applib::format_deci(Invoice::allsum_cost_quant($id));?>" name="total_cost_quantity">
                     <input type="hidden" class="form-control"  value="<?=Applib::format_deci(Invoice::allsum_sale_quant($id));?>" name="total_sale_quantity">
