								...
								<div class="row AlLRevenues">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" name="revenue_amount[]" placeholder="Amount" value="" class="form-control RevenuEAmount" autocomplete="off" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="col-sm-6">
											<label>Quantity <span class="text-danger">*</span></label>
											<input type="number" required="" name="revenue_quantity[]" class="form-control revenue_quantity">
										...
										<div class="col-sm-6">
											...
											<div class="cal-icon">
											<input type="text" required="" class="form-control datetimepicker" data-date-format="dd-mm-yyyy" name="revenue_create_date[]"></div>
										</div>
							...
							<div class="AllExpensesClass">
								<div class="row AlLExpenses">
									...
									<div class="col-md-4">
										<div class="col-sm-6">
											<label>Quantity <span class="text-danger">*</span></label>
											<input type="text" required="" name="expenses_quantity[]" class="form-control exp_qty">
											<input type="hidden" name="total_amt_exp[]" class="total_amt_exp" >
										</div>
										<div class="col-sm-6">
											<label>Created at <span class="text-danger">*</span></label>
											<div class="cal-icon">
											<input type="text" required="" class="form-control datetimepicker" data-date-format="dd-mm-yyyy" name="expenses_create_date[]"></div>
										</div>
									</div>
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" name="expected_profit_rate" readonly class="percent" id="percent" value="" placeholder="Expected Profit %" >
									</div>								
								</div>
