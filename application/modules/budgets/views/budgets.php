                    ...
                    <?php $i = 1; foreach($budgets as $budget){ 
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          <?=Applib::format_currency($inv->currency, $budget['overall_revenues']);?>

                          <?php// echo $budget['overall_revenues']; ?>
                            

                          </td>
                        <td style="text-align: center;">
                          <?=Applib::format_currency($inv->currency, $budget['overall_expenses']);?>

                          <?php// echo $budget['overall_expenses']; ?>
                        ...
                        <td style="text-align: center;">
                          ...
                          <?php  
                             if (!empty($budget['tax_amount'])) {
                              echo Applib::format_currency($inv->currency, $budget['tax_amount']);
                             }
                             else{
                              echo "--";
                             }
                             ...
                             ?>
                          <?php// echo $budget['tax_amount']; ?>
                            
                          </td>
                        <td style="text-align: center;">
                          <?=Applib::format_currency($inv->currency, $budget['budget_amount']);?>
                          <?php// echo $budget['budget_amount']; ?>
