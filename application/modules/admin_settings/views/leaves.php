<div class="p-0">
    ...
    <div class="col-lg-12 p-0">
						...
						<?php foreach($leave_res as $key => $vl){?>
							<tr>
								...
								<td class="text-right"> 
									...
									<a class="btn btn-danger btn-xs" title="Delete" data-toggle="ajaxModal" href="<?=base_url()?>admin_settings/delete_leave_types/<?=$vl['id']?>" data-original-title="Delete">
		...
		echo form_open_multipart('admin_settings/leave_types', $attributes); ?>
