<div class="panel panel-white">
	...
	<div class="panel-body">
		...
		<div class="col-xs-12 text-right m-b-20">
			<a href="<?php echo base_url(); ?>admin_settings/new_menu_role/"><span class="btn btn-info">New Role</span></a>
		</div>
	</div>
		<?php 
			        ...
			        <table id="table-rates" class="table table-striped custom-table m-b-0 AppendDataTables">
			            ...
			            <tbody>
							...
							$dis_date = date_format($date,"d M Y"); 
			            		...
			            		<tr>
			            			<td><?php echo $e; ?></td>
			            			<td><a href="<?php echo base_url(); ?>admin_settings/role_view/<?php echo $roles['role']; ?>"><?php echo ucfirst(str_replace('_',' ', $roles['role'])); ?></a></td>
			            			<td><?php echo $des; ?></td>
			            			<td><?php echo $dis_date; ?></td>
			            			<td style="text-align: center;">
			            				<?php if($roles['role'] != 'admin'){ ?>
				            				<a class="btn btn-danger btn-xs" href="<?=base_url()?>admin_settings/roles_delete/<?php echo $roles['r_id']; ?>" data-toggle="ajaxModal" title="<?=lang('delete_role')?>"><i class="fa fa-trash-o"></i></a>
				            			<?php }else{ ?>
