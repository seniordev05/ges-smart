<div class="p-0">
    ...
    switch ($view) {
        ...
        echo form_open_multipart('admin_settings/update', $attributes); ?>
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('timezone')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('currency_position')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('currency_decimals')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                            <select name="currency_decimals" class="form-control">
                                ...
                                <option value="3"<?=(config_item('currency_decimals') == 3 ? ' selected="selected"' : '')?>>3</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('tax_decimals')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('quantity_decimals')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('date_format')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('enable_languages')?> </label>
                        <div class="col-lg-3">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('use_gravatar')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('allow_client_registration')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('file_max_size')?> <span class="text-danger">*</span> </label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('allowed_files')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" value="<?=config_item('allowed_files')?>" name="allowed_files">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('client_create_project')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('auto_close_ticket')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('ticket_start_number')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                            <input type="text" name="ticket_start_no" class="form-control" value="<?=config_item('ticket_start_no')?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('default_department')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
					...
					<div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('stop_timer_logout')?></label>
                        <div class="col-lg-3">
                            <label class="switch">
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?=lang('employee_number')?> <span class="text-danger">*</span></label>
                        <div class="col-lg-3">
                            <input type="text" name="employee_number" class="form-control" value="<?=config_item('employee_number')?>">
                        </div>
                    </div>
