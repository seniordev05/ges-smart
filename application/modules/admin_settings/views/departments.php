                        ...
                        <table id="table-templates-2" class="table table-striped table-bordered AppendDataTables">
                            ...
                            if (!empty($designation)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?=base_url()?>admin_settings/edit_designation/<?=$des->id?>" class="btn btn-success btn-xs" data-toggle="ajaxModal">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="<?=base_url()?>admin_settings/delete_designation/<?=$des->id?>" class="btn btn-danger btn-xs" data-toggle="ajaxModal">
                                            <i class="fa fa-trash-o"></i>
                                        </a>
                                    </td>
                                </tr>
