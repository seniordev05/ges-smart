<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id'=>'leadReporterEdit'); echo form_open(base_url().'admin_settings/lead_reporter_edit/'.$reporter_details['reporter_id'],$attributes); ?>
