...
class Tank_auth
{
	...
	*/
	...
	// 				$this->ci->config->item('phpass_hash_strength', 'tank_auth'),
	// 				$this->ci->config->item('phpass_hash_portable', 'tank_auth'));
	// 		$hashed_password = $hasher->HashPassword('test@admin');	
	// 			echo $hashed_password; die('hello');
	...
	public function password_make(){
		$hashed_password = $hasher->HashPassword('test@admin.com');
