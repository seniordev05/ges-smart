...
$(document).on('click','.DeleteDeduction',function(){
    ...
    $(document).on("keyup", ".revenue_quantity", function() {
        var total_amt=0;
        var revenue_qty = $(this);
        $('.RevenuEAmount').each(function() {
         var revenue_amt = $(this);
          total_amt=revenue_qty.val()*revenue_amt.val();
        });
       $(this).parent().find('.total_amt').val(total_amt);
       all_revenue();
      // alert($(this).parent().attr('class'));
        //alert(total_amt);
    });

    function all_revenue(){
        var total_amount=0;
        $('.total_amt').each(function(){
           total_amount+= parseInt($(this).val());
        });
        // alert(total_amount);
$('#overall_revenues').val(total_amount);    

 var overall_revenue = $('#overall_revenues').val();
        var overall_expenses = $('#overall_expenses').val();
        var total_amount = parseInt(overall_revenue) - parseInt(overall_expenses);
        var percent_total_amt=total_amount/parseInt(overall_revenue)*100;
        var percent_of_total_amt=percent_total_amt.toFixed(2);
        $('#percent').val(percent_of_total_amt+'%');
        $('#expected_profit').val(total_amount);
        $('#budget_amount').val(total_amount);
    ...
    $(document).on("keyup", ".exp_qty", function() {
        var total_amt=0;
        var exp_qty = $(this);
        $('.EXpensesAmount').each(function() {
         var exp_amt = $(this);
          total_amt_exp=exp_qty.val()*exp_amt.val();
        });
       $(this).parent().find('.total_amt_exp').val(total_amt_exp);
       all_expense();
      // alert($(this).parent().attr('class'));
        //alert(total_amt);
    });
    ...
    function all_expense(){
        var total_amount_exp=0;
        $('.total_amt_exp').each(function(){
           total_amount_exp+= parseInt($(this).val());
        });
        $('#overall_expenses').val(total_amount_exp);  
    ...
    // $(document).on("keyup", ".revenue_quantity", function() {
    //     // revenue_amount_update();
    //     var revenue_qty = $(this);
    //     var amount=0;
    //     var last_over=0;
    //     $('.RevenuEAmount').each(function() {
    //         var revenue_amount = $(this);
    //         var new_rev_amt=revenue_amount.val()*revenue_qty.val();
    //         // amount += +new_rev_amt; 
    //         if ($('#overall_revenues').val()=='') {
    //             $('#overall_revenues').val(0);
    //         }
    //         last_over=new_rev_amt + parseInt($('#overall_revenues').val());
    //     });
    //     $('#overall_revenues').val(last_over);
...
//revenue overall uopdate 



function revenue_amount_update(){
    $(document).on("keyup", ".revenue_quantity", function(){
      var revenue_qty = $(this);
        var amount=0;
        var last_over=0;
